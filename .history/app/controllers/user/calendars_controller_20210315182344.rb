class User::CalendarsController < User::Base
  ...
  def params_calendar
    params.require(:calendar).permit(:calendar_name, :start_date, :end_date, :display_week_term, :public_uid, :is_released, :address, :phone, :start_time, :end_time, :display_time, :display_interval_time, :message, :picture)
  end
