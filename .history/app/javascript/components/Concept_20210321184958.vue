...
<div class="conCeptGroup">
  <article id="concept">
    <section class="cnt1 effect" style="height: 400.95px;">
      ...
      <div class="image in1 ac-end"  style="height: 400.95px;">
        <div class="bg">
          <!-- <img class="slide-img" v-bind:src="image"> -->
        </div>
      </div>
    </section><!-- / .cnt1 -->
    <section class="cnt2 effect" style="height: 400.95px;">
      ...
      <div class="image-box">
        <div class="image in2 ac-end" style="opacity: 1; height: 400.95px;">
          <div class="bg">
            <!-- <img class="slide-img" v-bind:src="image" style="opacity: 1; height: 400.95px;"> -->
          </div>
        </div>
        <div class="image in3 ac-end" style="opacity: 1; height: 400.95px;">
          <div class="bg">
            <!-- <img class="slide-img" v-bind:src="image" style="opacity: 1; height: 400.95px;"> -->
          </div>
        </div>
...
#concept .cnt2 .image-box .in2 .bg {
  width: 100%;
  height: 100%;
  background: url("../../assets/images/image_gallery1.jpg") no-repeat center center;
  /* background: url(../../assets/images/image_gallery1.jpg) no-repeat center center; */
  display: block;
