...
<div class="conCeptGroup">
  <article id="concept">
    <section class="cnt1 effect" style="height: 400.95px;">
      ...
      <div class="image in1 ac-end">
        <div class="bg">
          <img class="slide-img" v-bind:src="image" style="height: 400.95px;">
        </div>
      </div>
    </section><!-- / .cnt1 -->
...
#concept .cnt1, #concept .cnt2, #gallery, #instagram {
    margin: 100px auto;
}
}
