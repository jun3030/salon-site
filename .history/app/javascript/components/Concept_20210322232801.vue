...
<article id="concept">
  <div class="cnt1 effect" style="height: 400.95px">
    <div class="l-box" style="height: 400.95px;">
      <div class="text-box">
        ...
        <h3 class="ac-t1">女の子のステキと、<br>女性の素敵をデザインする。</h3>
        <p class="ac-t2">美容は、人を笑顔にし、人の心を豊かにする。美容は、人を幸せにし、人が美しく生きる、女性が生きる。美容は、人としての在り方、生き方につながる。そんな「美容のチカラ」を全てのお客様に、ご提案致します。</p>
      </div>
      <br><img class="concept-image" v-bind:src="conceptImage">
      <!--<a href="" class="link"><p>CONCEPT</p></a>-->
    </div><!-- / .l-box -->
  </div><!-- / .cnt1 -->

  <div class="cnt2 effect">
    <div class="l-box">
      <div class="text-box">
  ...
  <div id="slide-box" class="image ac-end" style="opacity: 1;">
        <ul class="bg">
            <li class="slide" id="slide-1"></li>
            <li class="slide next" id="slide-2"></li>
            <li class="slide future" id="slide-3"></li>
            <li class="slide future" id="slide-4"></li>
            <li class="slide future" id="slide-5"></li>
        </ul>
    <div class="controls"><a class="prev" href="Javascript:;"></a><span class="current">1/5</span><a class="next" href="Javascript:;"></a></div></div>
</article>
</article>
...
export default {
  ...
  data: function () {
    return {
      ...
      conceptImage2: require('../../assets/images/image_concept2.jpg')
    }
  }
}
</script>>
