<template>
  <article id="gallery" class="effect">
    ...
    <Carousel>
      <CarouselSlide v-for="(slide, index) in slides" :key="slide">
        <img :src="slide">
      </CarouselSlide>
    </Carousel>
  </article>
  ...
  data: function () {
    return {
      slides: [
        ...
        "https://picsum.photos/id/3/600/350",
        "https://picsum.photos/id/4/600/350",
        "https://picsum.photos/id/5/600/350",
      ],
      test: "https://picsum.photos/id/1/600/350",
      visibleSlide: 0,
    }
  },
  components: {
