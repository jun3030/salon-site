class Staff < ApplicationRecord
  ...
  def create_staff_shifts
    ...
    [*start_of_month..end_of_month].each do |date|
      ...
      start_time = Time.parse(date.to_s, jst).change(hour: staff_regular_holiday.work_start_at.hour, min: staff_regular_holiday.work_start_at.min)
      ...
      if staff_regular_holiday.is_rest?
        ...
        shift.staff_rest_times.build(rest_stat_time: start_time.change(hour: staff_regular_holiday.rest_start_time.hour),
