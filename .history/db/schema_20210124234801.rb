...
ActiveRecord::Schema.define(version: 2021_01_24_141232) do
  ...
  create_table "calendar_configs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.integer "cancelable_time", default: 24, comment: "お客様が、web上で予約時間の何時間前までキャンセルを許容するかの設定"
    t.integer "interval_time", default: 0, comment: "一つ一つの予約の間に準備時間を入れることができる"
    t.text "booking_message", comment: "予約時、お客様へのメッセージ。お客様への予約通知に任意のメッセージを入れることができる"
  ...
  create_table "calendars", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.integer "start_date", default: 1, comment: "0と設定すると本日の予約から受付可能"
    t.integer "end_date", default: 7, comment: "何日後まで予約できるようにするかを設定"
    t.integer "display_week_term", default: 3, comment: "表示期間（週間）"
    t.integer "start_time", default: 9, comment: "表示開始時刻（時）"
    t.integer "end_time", default: 18, comment: "表示終了時刻（時)"
    t.boolean "is_released", default: false, comment: "カレンダーの公開、非公開"
    t.integer "display_time", default: 5, comment: "お客様の予約カレンダーで現時刻から、何時間後の予約から許容するかの設定"
  ...
  create_table "task_courses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.integer "course_time", comment: "時間"
    t.string "charge", comment: "値段"
