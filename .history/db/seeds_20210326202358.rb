...
TaskCourse.create!(calendar_id: 1, title:"ワンタッチ", description:"髪の毛を切る", course_time: 60, charge: "5000")
TaskCourse.create!(calendar_id: 1, title:"ツータッチ", description:"髪の毛を切る", course_time: 60, charge: "5000")
