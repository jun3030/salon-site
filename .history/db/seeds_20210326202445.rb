...
TaskCourse.create!(calendar_id: 1, title:"ツータッチ", description:"カラー", course_time: 60, charge: "5000")
TaskCourse.create!(calendar_id: 1, title:"ダブルカラー", description:"カラー", course_time: 60, charge: "5000")
TaskCourse.create!(calendar_id: 1, title:"AVEDAカラー", description:"髪の毛を切る", course_time: 60, charge: "5000")
