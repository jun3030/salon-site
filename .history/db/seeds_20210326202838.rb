...
TaskCourse.create!(calendar_id: 1, title:"ヘッドスパ各種", description:"パーマ", course_time: 60, charge: "2500")
TaskCourse.create!(calendar_id: 1, title:"個室スパ", description:"パーマ", course_time: 60, charge: "11700")
TaskCourse.create!(calendar_id: 1, title:"ストレートパーマ", description:"パーマ", course_time: 60, charge: "11700")
TaskCourse.create!(calendar_id: 1, title:"ストレートパーマ", description:"パーマ", course_time: 60, charge: "11700")
TaskCourse.create!(calendar_id: 1, title:"ストレートパーマ", description:"パーマ", course_time: 60, charge: "11700")
