...
TaskCourse.create!(calendar_id: 1, title:"シャンプー&ブロー", description:"パーマ", course_time: 60, charge: "2500")
TaskCourse.create!(calendar_id: 1, title:"セット / アップ", description:"パーマ", course_time: 60, charge: "3000")
TaskCourse.create!(calendar_id: 1, title:"ポイントメイク / フルメイク", description:"パーマ", course_time: 60, charge: "11700")
