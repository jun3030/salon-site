...
TaskCourse.create!(calendar_id: 1, title:"個室スパ", description:"トリートメント", course_time: 30, charge: "2500")
TaskCourse.create!(calendar_id: 1, title:"シャンプー&ブロー", description:"シャンプー", course_time: 60, charge: "2500")
TaskCourse.create!(calendar_id: 1, title:"セット / アップ", description:"セット", course_time: 60, charge: "3000")
TaskCourse.create!(calendar_id: 1, title:"ポイントメイク / フルメイク", description:"メイク", course_time: 60, charge: "2000")
