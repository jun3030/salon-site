...
Staff.create!(calendar_id: 1, name:"稲森 春香", email:"staff2@email.com", description: "お客様の悩みとしっかり向き合い、あなたに似合う最高の"美"を提案します！安心して、お任せください。素敵なデザインを一緒につくりましょう。", staff_part: "DIRECTOR")
Staff.create!(calendar_id: 1, name:"中森 大貴", email:"staff3@email.com", description: "元気いっぱいです！", staff_part: "SUB DIRECTOR")
Staff.create!(calendar_id: 1, name:"スタッフA", email:"staff4@email.com", description: "元気いっぱいです！", staff_part: "店長")
Staff.create!(calendar_id: 1, name:"スタッフA", email:"staff5@email.com", description: "元気いっぱいです！", staff_part: "店長")
