...
Staff.create!(calendar_id: 1, name:"稲森 春香", email:"staff2@email.com", description: "お客様の悩みとしっかり向き合い、あなたに似合う最高の美を提案します！安心して、お任せください。素敵なデザインを一緒につくりましょう。", staff_part: "DIRECTOR", , picture: File.open(Rails.root.join('app/assets/images/')))
