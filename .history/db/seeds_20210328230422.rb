...
※高木の予約は混雑しますので、1～2週間前の予約をお勧めします。", staff_part: "店長", picture: File.open(Rails.root.join('app/assets/images/DkxxWohP_400x400.jpg')))
Staff.create!(calendar_id: 1, name:"稲森 春香", email:"staff2@email.com", description: "お客様の悩みとしっかり向き合い、あなたに似合う最高の美を提案します！安心して、お任せください。素敵なデザインを一緒につくりましょう。", staff_part: "DIRECTOR", picture: File.open(Rails.root.join('app/assets/images/image_gallery1.jpg')))
Staff.create!(calendar_id: 1, name:"中森 大貴", email:"staff3@email.com", description: "ナチュラルなスタイルからエッジの効いたスタイルまで、どんなテイストでもお任せください‼お客様に似合うお洒落で素敵なスタイルを一緒に創りましょう★", staff_part: "SUB DIRECTOR", picture: File.open(Rails.root.join('app/assets/images/image_gallery1.jpg')))
Staff.create!(calendar_id: 1, name:"大野 仁美", email:"staff4@email.com", description: "女性としてママとして主婦として。いろんな目線からお客様だけの素敵をデザインさせて頂きます♪", staff_part: "STYLIST", picture: File.open(Rails.root.join('app/assets/images/image_gallery1.jpg')))
