...
Staff.create!(calendar_id: 1, name:"鈴木 ケイ", email:"staff5@email.com", description: "年齢・性別にとらわれず自分らしい選択ができる自由を、美容を通して提案します！あなただけの素敵を一緒につくりましょう☆", staff_part: "TOP STYLIST", picture: File.open(Rails.root.join('app/assets/images/image_staff_suzukikei.jpeg')))
